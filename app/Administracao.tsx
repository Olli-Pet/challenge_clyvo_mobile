...
export default function Administracao() {
  ...
  const { mutateAsync: cadastrar, isPending: cadastrando } =
    useCadastrarVeterinario();
          ...
          <View style={estilos.faixa}>
            <View style={estilos.faixaTopo}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={estilos.faixaSub}>
                  Olá, {usuario?.nome || "Clínica"}!
                </Text>
              </View>
            ...
            <Text style={estilos.faixaDesc}>
              Cadastre e gerencie os veterinários da clínica.
            </Text>
          </View>

          <View style={estilos.cabecalhoSecao}>
            <Ionicons name="medkit-outline" size={20} color={ROXO} />
            <Text style={estilos.tituloSecao}>
              Equipe clínica ({equipe.length})
            </Text>
          </View>
          ...
          {!formularioAberto ? (
            ...
            <View style={estilos.formulario}>
              ...
              <Text style={estilos.formularioAviso}>
                Ele criará a senha no primeiro acesso, com o e-mail informado
                aqui.
              </Text>
...
const estilos = StyleSheet.create({
  ...
  tituloSecao: { fontSize: 16, fontWeight: "700", color: "#333" },
  botao: {
    flexDirection: "row",
    alignItems: "center",
